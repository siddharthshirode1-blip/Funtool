...
// /* ================= Checking Logic ================= */
// function checkanswer() {
//     // Grab the text sitting inside the spans
//     let quest = document.getElementById("question").innerText; 
//     let userAns = document.getElementById("answer").innerText;
    
//     // Look up the correct answer in our dictionary
//     let correctAns = alphamorsedic[quest];

//     if (userAns === correctAns) {
//         alert("BOOM! Correct! 🎯");
//         generateQuestion(); // Give them a new letter to translate!
//     } else {
//         alert("Oops! Try again. " + quest + " is " + correctAns);
//         clearanswer(); // Wipe their wrong answer so they can try again
//     }
// }
// $(document).ready(function(){
// })
...
// /* ======================= Question Random ======================= */
// let Start = document.getElementById("starting").value;
// let End = document.getElementById("ending").value;

// function getRandomAlphabet(Start,End) {
